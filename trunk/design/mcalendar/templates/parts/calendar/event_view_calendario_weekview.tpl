...
<script type="text/javascript" src={'javascript/calendar_week.js'|ezdesign} ></script>
<script type="text/javascript" src={'javascript/maketime.js'|ezdesign} ></script>
<script type="text/javascript" src={'javascript/classes/weekCalendar.js'|ezdesign} ></script>
{/if}